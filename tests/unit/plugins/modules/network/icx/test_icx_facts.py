...
from ansible_collections.synominit.icx.plugins.modules import icx_facts
...
class TestICXFactsModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            "ansible_collections.synominit.icx.plugins.modules.icx_facts.run_commands"
        )
    ...
    def test_icx_facts_hardware(self):
        ...
        self.assertEqual(
            result["ansible_facts"]["ansible_net_memfree_kb"]["Stack Unit 1"][
                "Free Memory"
            ],
            "367152.0kb",
        )
        self.assertEqual(
            result["ansible_facts"]["ansible_net_memtotal_kb"]["Stack Unit 1"][
                "Total Memory"
            ],
            "932320.0kb",
        )
