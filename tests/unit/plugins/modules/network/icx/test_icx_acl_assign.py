...
from ansible_collections.commscope.icx.plugins.modules import icx_acl_assign
...
class TestICXAclAssignModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch(
            "ansible_collections.commscope.icx.plugins.modules.icx_acl_assign.load_config"
        )
        self.load_config = self.mock_load_config.start()
        self.mock_exec_command = patch(
            "ansible_collections.commscope.icx.plugins.modules.icx_acl_assign.exec_command"
        )
