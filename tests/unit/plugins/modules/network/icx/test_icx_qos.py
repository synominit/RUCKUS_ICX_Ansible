...
class TestICXQosModule(TestICXModule):
    ...
    def load_fixtures(self, commands=None):
        ...
        self.exec_command.return_value = (
            0,
            load_fixture("icx_qos_show_profile").strip(),
            None,
        )
    ...
    def test_egress_buffer_profile_absent(self):
        ...
        expected_commands = [
            "no qos egress-buffer-profile euser1 port-share-level level5-1/5"
        ]
    ...
    def test_egress_buffer_profile_present(self):
        ...
        result = self.execute_module(changed=True)
        expected_commands = [
            "qos egress-buffer-profile euser1 port-share-level level5-1/5"
        ]
        self.assertEqual(result["commands"], expected_commands)
    ...
    def test_icx_egress_buffer_profile_7X50_present(self):
        ...
        commands = [
            "qos egress-buffer-profile euser1 queue-share-level level6-1/3 4"
        ]
        result = self.execute_module(changed=True)
    ...
    def test_icx_egress_buffer_profile_7X50_absent(self):
        ...
        commands = [
            "no qos egress-buffer-profile euser1 queue-share-level level6-1/3 4"
        ]
        result = self.execute_module(changed=True)
        self.assertEqual(result["commands"], commands)
    ...
    def test_icx_egress_shape_ifg_bytes_absent(self):
        set_module_args(
            dict(
                egress_shape_ifg_bytes=dict(value_in_bytes=25, state="absent")
            )
        )
    ...
    def test_icx_egress_shape_ifg_bytes_present(self):
        set_module_args(
            dict(
                egress_shape_ifg_bytes=dict(value_in_bytes=25, state="present")
            )
        )
    ...
    def test_icx_ingress_buffer_profile_present(self):
        ...
        commands = [
            "qos ingress-buffer-profile iuser1 priority-group 1 xoff level4-1/9"
        ]
        result = self.execute_module(changed=True)
        self.assertEqual(result["commands"], commands)
    ...
    def test_icx_ingress_buffer_profile_absent(self):
        ...
        commands = [
            "no qos ingress-buffer-profile iuser1 priority-group 1 xoff level4-1/9"
        ]
        result = self.execute_module(changed=True)
        self.assertEqual(result["commands"], commands)
    ...
    def test_icx_mechanism_absent(self):
        set_module_args(
            dict(mechanism=dict(queueing_method="weighted", state="absent"))
        )
    ...
    def test_icx_queue_name(self):
        set_module_args(
            dict(queue_name=dict(old_name="qosp1", new_name="euser1"))
        )
    ...
    def test_icx_priority_to_pg_preset(self):
        ...
        commands = [
            "qos priority-to-pg  qosp0 0 qosp1 1 qosp2 1 qosp3 1 qosp4 2 qosp5 2 qosp6 2 qosp7 4"
        ]
        result = self.execute_module(changed=True)
        self.assertEqual(result["commands"], commands)
    ...
    def test_icx_priority_to_pg_absent(self):
        ...
        commands = [
            "no qos priority-to-pg  qosp0 0 qosp1 1 qosp2 1 qosp3 1 qosp4 2 qosp5 2 qosp6 2 qosp7 4"
        ]
        result = self.execute_module(changed=True)
        self.assertEqual(result["commands"], commands)
    ...
    def test_icx_profile_absent(self):
        ...
        commands = [
            "no qos profile qosp7 25 qosp6 15 qosp5 12 qosp4 12 qosp3 10 qosp2 10 qosp1 10 qosp0 6"
        ]
        result = self.execute_module(changed=True)
        self.assertEqual(result["commands"], commands)
    ...
    def test_icx_profile_absent(self):
        ...
        commands = [
            "qos profile qosp7 25 qosp6 15 qosp5 12 qosp4 12 qosp3 10 qosp2 10 qosp1 10 qosp0 6"
        ]
        result = self.execute_module(changed=True)
        self.assertEqual(result["commands"], commands)
    ...
    def test_icx_scheduler_profile_preset(self):
        ...
        commands = [
            "qos scheduler-profile euser1 mechanism weighted",
        ...
        set_module_args(
            dict(
                sflow_set_cpu_rate_limit=dict(
                    packet_rate="1000", burst_size="5000", state="absent"
                )
            )
        )
    ...
    def test_icx_tagged_priority_preset(self):
        set_module_args(
            dict(tagged_priority=dict(num=2, queue="qosp0", state="present"))
        )
